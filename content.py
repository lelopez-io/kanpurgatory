...
class Content:
    ...
    story: tuple[tuple[str, ...], ...] = (
        ...
        (
            ...
            "",
            "A kind lady shared her",
            "own uncertainty, blessing us",
            "with good wishes as we traded",
        ...
        (
            ...
            "as they began digging their",
            "vehicles free without waiting",
            "for institutional aid."
        ),
        # Staff indifference
        (
            "The hotel's response to our",
            "predicament was telling - a",
            "single shovel, available only",
            "if we surrendered an ID at",
            "the front desk. They showed",
            "no interest in clearing their",
            "own parking lot||| leaving us",
            "to forge our own salvation.",
            "",
